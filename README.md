...
This is where the main password generation functionality is provided.

![picture alt](./assets/appui01_index.jpg "index.HTML")

### 2.2.2. About Page.

The following page was provided in order to assure responsive design was achieved. Detailed instructions are provided as well as supporting links. 
