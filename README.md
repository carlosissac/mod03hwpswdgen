...
Object oriendted design should be the first thing to be taken into account when moving forward with implementation. This will pay off significant dividends during as we move forward in development and will make our separation of concerns easier to estimate, consequently our code will be easier to oragnize, build and test. 
